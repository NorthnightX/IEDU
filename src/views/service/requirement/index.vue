<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="学历" prop="eduEdu">
        <el-input
          v-model="queryParams.eduEdu"
          placeholder="请输入学历"
          clearable
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          icon="Plus"
          @click="handleAdd"
          v-hasPermi="['service:requirement:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['service:requirement:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['service:requirement:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          icon="Download"
          @click="handleExport"
          v-hasPermi="['service:requirement:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="requirementList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="学历" align="center" prop="eduEdu" />
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['service:requirement:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['service:requirement:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="requirementRef" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="学历" prop="eduEdu">
          <el-input v-model="form.eduEdu" placeholder="请输入学历" />
        </el-form-item>
      </el-form>
      <template #footer>
...
import { listRequirement, getRequirement, delRequirement, addRequirement, updateRequirement } from "@/api/service/requirement";
...
function handleUpdate(row) {
  ...
  getRequirement(_eduId).then(response => {
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除学历要求编号为"' + _eduIds + '"的数据项？').then(function() {
    return delRequirement(_eduIds);
  }).then(() => {
    getList();
...
function handleExport() {
  proxy.download('service/requirement/export', {
    ...queryParams.value
